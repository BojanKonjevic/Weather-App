...
function TemperatureAndDetails() {
  return (
    <div>
      <div className='flex items-center justify-center py-6 text-xl text-cyan-300'><p>Clear</p></div>
      ...
      <div className='flex flex-row justify-center items-center space-x-2 text-white text-sm py-3'>
        ...
        <UilSunset/>
        <p className='font-light'>Set: <span className='font-medium ml-1'>7:35 AM</span></p>
        <p className='font-light'>|</p>
